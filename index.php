...
?>
	...
	<?php } ?>
			...
			<div class="more-info-tab clearfix">
			<hr>
			   <h3 class="new-product-title pull-left">Purchased Products</h3>
				<br><hr>
				<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
<?php
$ret=mysqli_query($con,"select products.id,products.productImage1,products.productName,products.productPrice,products.productPriceBeforeDiscount,products.productAvailability from products,orders where products.id=orders.productId and orders.userId='".$_SESSION['id']."'");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
?>
	...
	<?php } ?>
			...
			<div class="more-info-tab clearfix">
			<hr>
			<?php $command = escapeshellcmd('python recommondation.py');
      $output = shell_exec($command); ?>
			   <h3 class="new-product-title pull-left"></h3>
				...
				<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
<?php
$ret=mysqli_query($con,"select distinct products.id,products.productImage1,products.productName,products.productPrice,products.productPriceBeforeDiscount,products.productAvailability from products,predicted where products.id=predicted.productid and predicted.userid='".$_SESSION['id']."' and predicted.status='1'");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
?>
	...
	<?php } ?>
			...
			<div class="more-info-tab clearfix">
			<hr>
			<?php $command = escapeshellcmd('python Association_Rule_Mining.py');
      $output = shell_exec($command); ?>
			   <h3 class="new-product-title pull-left">Recommended Products</h3>
				...
				<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
<?php
$ret11=mysqli_query($con,"select distinct association.antecedent,association.consequent,products.id,products.productImage1,products.productName,products.productPrice,products.productPriceBeforeDiscount,products.productAvailability,orders.userId,orders.productId from association,products,orders where association.antecedent=products.productName and orders.productId=products.id and orders.userId='".$_SESSION['id']."'");
while ($row1=mysqli_fetch_array($ret11)) 
{
	# code...
	$sugproduct=$row1['consequent'];
	$ret=mysqli_query($con,"select distinct products.id,products.productImage1,products.productName,products.productPrice,products.productPriceBeforeDiscount,products.productAvailability from products where products.productName='$sugproduct'");
	while ($row=mysqli_fetch_array($ret)) 
	{
?>
